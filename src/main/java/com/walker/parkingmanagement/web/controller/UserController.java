...
public class UserController {
    ...
    @Operation(summary = "Recupera um usuário pelo id", description = "Recurso para recuperar um usuário pelo id",
            responses = {
    ...
    @Operation(summary = "Atualiza senha", description = "Recurso para atualizar senha",
            responses = {
